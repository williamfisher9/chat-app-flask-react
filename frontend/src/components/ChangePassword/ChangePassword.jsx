...
const ChangePassword = () => {
    ...
    const handleChangePasswordRequest = () => {
        ...
        if(!hasErrors){
            axios.post("https://willtechbooth.dev/chatter/api/v1/users/change-password", {"user_id": params.source_user, "current_password": formFields.currentPassword, "new_password": formFields.newPassword})
            .then((res) => {
                if(res.status == 200){
                    console.log(res)
