...
const Register = () => {
    ...
    const handleSignUpRequest = () => {
        ...
        if(!hasErrors){
            axios.post("http://3.145.152.55:3030/api/v1/users/signup", {"email_address": formFields.emailAddress, 
    ...
    return <div className='w-full min-h-screen flex justify-center items-center'>
        <form className='w-[500px] max-[550]:w-[400px] min-h-11 border-2 border-[var(--global-color)] rounded-lg pb-8 flex flex-col gap-7 justify-center items-center overflow-hidden'>
